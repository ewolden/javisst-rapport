...
The project progression derives from the activity plan (Appendix \ref{app:activity_plan}), meeting minutes (Appendix \ref{app:group_meeting}) and Trello archive and will only briefly summarize what was done at each sprint and only serves as a "quick tour" through the development process.
