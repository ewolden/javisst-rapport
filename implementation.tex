...
\begin{description}
	...
	Work was conducted after the last sprint(sprint 14) this was mainly fixing crucial bugs in the application, finalizing the report, as well as carry out an acceptance test \todo{ref acceptance test} with the customer.
