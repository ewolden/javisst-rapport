...
The burn down estimate done at the start of the project can be found in \textbf{Figure \ref{Fig:burndownstart}} below. The final burn down of the project can be seen in \textbf {Figure \ref{Fig:burnDownAfter}} in \textbf{Section \ref{sec:project_progression}}.
