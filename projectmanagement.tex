...
As was noted in \textbf{Section \ref{sec:scrum}}, an important part of the scrum methodology is the close collaboration between the team members. Scrum provides some events to enhance this collaboration, for instance the daily scrum meetings, and some artifacts, such as the sprint backlog \todo{This is not introduced? at least not in this chapter}. These features of scrum were used by the group and helped create a framework for the process development. However, scrum does not define how the group should interact, and the group interaction consisted of more than the methods provided by scrum, for instance when doing sessions of collaborative work.\newline
...
\begin{itemize}
	...
	\item Comment code
	\item Divide the code into logical units \todo{referer til hvordan angularjs bidrar til å løse dette, beskrevet i design and architecture}
