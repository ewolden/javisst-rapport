...
\begin{table}[!h]
	...
	\begin{tabular}{ | p{2.5cm} | p{8cm} | p{1.5cm} | p{3cm} | }	
		...
		Interoperability & How important is the ability for the system to work together with other systems. (eg. making use of specific communication protocols or the use of a specified data format)B8 & 5 & 	\\\hline
