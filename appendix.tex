...
\begin{center}
	...
	\hline {\bf ID} & {\bf Name} & {\bf Description} & {\bf Priority} & {\bf Use Case Ref.} & {\bf Comments}\\ \hline
		...
		R15 & Bookmark story / Add story to list  & The user should be given the opportunity to connect a story to bookmarks. The bookmarks could be predefined by the system, like "Les senere" or defined by the user & M  & U5 &\\\hline
