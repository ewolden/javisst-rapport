...
\begin{table}[!h]
	...
	\begin{adjustbox}{center}
		\begin{tabular}{ | l | l | l | l |}
			\hline
			\textbf{Recommender} & \textbf{Language} & \textbf{Filtering type} & \textbf{Documentation} \\ \hline
			\textbf{Mahout} & Java & Collaborative, Content-based possible & High \\ \hline
			\textbf{LensKit} & Java & Collaborative, Content-based possible & High \\ \hline
			\textbf{Duine} & Java & Hybrid & High \\ \hline
		\end{tabular}
	\end{adjustbox}
	\label{Tab:rec-tool}	
\end{table}
